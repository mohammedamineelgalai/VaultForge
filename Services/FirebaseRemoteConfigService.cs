...
namespace XnrgyEngineeringAutomationTools.Services
{
    ...
    public class FirebaseRemoteConfigService
    {
        ...
        /// <summary>
        /// Ouvre la page des releases GitHub (repo public separe - pas de code source)
        /// </summary>
        public static void OpenReleasesPage()
        {
            OpenDownloadUrl("https://github.com/mohammedamineelgalai/XnrgyEngineeringAutomationTools-Releases/releases/latest");
        }
    }
}
