        ...
        public bool Initialize()
        {
            ...
            lock (_lock)
            {
                ...
                try
                {
                    ...
                    Logger.Log("[INVENTOR] Connexion a Inventor Application...", Logger.LogLevel.INFO);
                    ...
                    catch
                    {
                        ...
                        Logger.Log("[INVENTOR] [!] Aucune instance Inventor active - veuillez demarrer Inventor d'abord", Logger.LogLevel.WARNING);
                        return false;
                    }
