        ...
        public bool SetIProperties(string filePath, string project, string reference, string module)
        {
            ...
            finally
            {
                ...
                if (!string.IsNullOrEmpty(backupPath) && File.Exists(backupPath))
                {
                    try
                    {
                        VaultFileHelper.CopyFile(backupPath, filePath, true);
                        VaultFileHelper.DeleteFile(backupPath);
                ...
                // Note: Ne PAS restaurer ReadOnly - les fichiers Vault doivent rester editables
            }
        }
