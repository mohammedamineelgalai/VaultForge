    ...
    public partial class CreateModuleWindow : Window
    {
        ...
        private void CopyDirectory(string sourceDir, string destDir)
        {
            ...
            foreach (var file in Directory.GetFiles(sourceDir))
            {
                ...
                // Utiliser VaultFileHelper pour retirer automatiquement l'attribut ReadOnly
                VaultFileHelper.CopyFile(file, destFile, true);
            }
        ...
        private void GetAllFilesRecursive(VDF.Vault.Currency.Connections.Connection connection, ACW.Folder folder, List<ACW.File> allFiles, List<ACW.Folder> allFolders)
        {
            ...
            catch (Exception ex)
            {
                ...
                Logger.Log($"[CreateModule] [!] Erreur enumeration {folder.FullName}: {ex.Message}", Logger.LogLevel.DEBUG);
            }
        }
