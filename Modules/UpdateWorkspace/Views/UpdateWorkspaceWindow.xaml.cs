...
namespace XnrgyEngineeringAutomationTools.Modules.UpdateWorkspace.Views
{
    ...
    public partial class UpdateWorkspaceWindow : Window
    {
            ...
            bool autoCloseOnSuccess = false)
        {
            ...
            _stepIcons = new TextBlock[11];
            _stepTexts = new TextBlock[11];
            _stepDetails = new TextBlock[11];
        ...
        private async void UpdateWorkspaceWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            _stepIcons[9] = IconStep10;
            _stepIcons[10] = IconStep11;
            ...
            _stepTexts[9] = TxtStep10;
            _stepTexts[10] = TxtStep11;
            ...
            _stepDetails[9] = DetailStep10;
            _stepDetails[10] = DetailStep11;
        ...
        private async void StartUpdate()
        {
            ...
            try
            {
                ...
                if (result.Success)
                {
                    ...
                    // IMPORTANT: Si autoCloseOnSuccess=true, le parent (RunStartupChecklist) 
                    // va gerer le lancement des applications pour eviter le double lancement
                    ...
                    {
                        AddLog("[i] Le lancement des applications sera gere par le processus parent");
                    }
        ...
        private void OnProgressChanged(object? sender, UpdateWorkspaceService.UpdateProgressEventArgs e)
        {
            Dispatcher.Invoke(() =>
            {
                // Combiner le statut et le nom du fichier en un seul texte
                string displayText = e.Status;
                if (!string.IsNullOrEmpty(e.CurrentFile))
                {
                    // Format: "Telechargement 350/1123 - NomFichier.ipt"
                    displayText = $"{e.Status} - {e.CurrentFile}";
                }
                UpdateProgress(e.Percent, displayText);
            });
        }
        ...
        private void AddLog(string message, UpdateWorkspaceService.LogLevel level = UpdateWorkspaceService.LogLevel.INFO)
        {
            ...
            // [+] Ecriture dans le Logger principal de l'application
            Logger.Log($"[UpdateWorkspace] {message}", logLevel);
